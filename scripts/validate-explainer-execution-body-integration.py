...
reg=ROOT/'engines/whiteboard-v3-system/NEXMIND_WHITEBOARD_V3_SYSTEM_PACKAGE/01_base_execution/Whiteboard_Execution_Body_V2/explainer-motion/whiteboard-v1/runtime/whiteboard_pil_adapter.py'; add('Whiteboard V3 preserved execution body installed',reg.exists(),str(reg))
